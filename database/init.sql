...
CREATE TABLE kereta (
    ...
    -- REVISI: Menggunakan ENUM agar pilihannya terkunci
    tipe_kereta ENUM('Ekonomi', 'Eksekutif') NOT NULL, 
);

-- 4. Tabel Pendukung: PENUMPANG
CREATE TABLE penumpang (
    -- REVISI: Gunakan ID Angka sebagai PK agar performa cepat
    id_penumpang INT AUTO_INCREMENT PRIMARY KEY,
    
    -- No ID & Email wajib unik (tidak boleh ada 2 orang pakai data sama)
...
CREATE TABLE tiket (
    ...
    -- Relasi ke Penumpang (Sekarang pakai ID angka)
    id_penumpang INT,
...
-- Input Kereta (Perhatikan kolom tipe_kereta harus sesuai ENUM)
...
-- Perhatikan: id_penumpang sekarang angka (1, 2, dst) bukan NIK lagi
